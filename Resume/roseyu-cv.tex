...
{\em Halıcıo\u{g}lu Data Science Institute}
%\vspace*{-.1in}
%\begin{list1}
...
\textbf{Facebook Data Science Research Awards},  Facebook Research, 2021

\textbf{AWS Machine Learning Research Awards},  Amazon Science, 2021
...
\item  Rui Wang, Danielle Maddix, Christos Faloutsos, Yuyang Wang, \underline{Rose Yu}. "Bridging Physics-based and Data-driven modeling for Learning Dynamical Systems", To appear in 
\textit{Annual Conference on Learning for Dynamics and Control}
 (L4DC), 2021 


\item Steven Wong, Lejun Jiang, Robin Walters, Tam{\'{a}}s G. Moln{\'{a}}r, G{\'{a}}bor Orosz,  \underline{Rose Yu}. "Physics-Guided Deep Learning for Traffic Forecasting using Vehicle-to-Vehicle Communication" To appear in 
\textit{Annual Conference on Learning for Dynamics and Control}
 (L4DC), 2021 
...
\section{\sc Invited Talk}
 ...
 CRUNCH Applied Math Group,  Brown University \hfill{April 2020}
 
 Featured Talk at NVIDIA GTC 2021   \hfill{March 2020}
  
 Applied Math Department Colloquium, University of Arizona   \hfill{Feb 2020}
  
 Duke University, Deep Learning Reading Group \hfill{Feb 2020}
