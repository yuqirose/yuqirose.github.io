...
Department of Computer Science and Engineering \\University of California, San Diego & {\it Phone:}  (617) 373-6455 \\            
...
{\em Network Science Institute, College of Engineering, Phyiscs (By Courtesy)}
...
Preprint \textit{arXiv:2006.11913}
...
"Learning Disentangled Representations of Video with Missing Data"
 Preprint \textit{arXiv:2006.13391}
...
"Multiresolution Tensor Learning for Efficient and Interpretable Spatial Analysis"
 In \textit{Proceedings  of the 32th International Conference on Machine Learning} (ICML), 2020

\item Rui Wang, Adrian Albert,  Karthik, Kashinath, Mustafa, Mustafa,  \underline{Rose Yu}. "Towards Physics-informed Deep Learning for Spatiotemporal Modeling of Turbulent Flows", In \textit{Proceeding of ACM SIGKDD Conference on Knowledge Discovery and Data Mining } (KDD), 2020


\item Nima Dehmamy, Albert-L\'aszl\'o Barab\'asi, \underline{Rose Yu}.  "Understanding the Representation Power of Graph Neural Networks in Learning Graph Topology" In \textit{Proceeding of Advances in Neural Information Processing Systems} (NeurIPS), 2019
 
 
\item  Yukai Liu, \underline{Rose Yu}, Stephan Zheng, Eric Zhan, Yisong Yue. "NAOMI: Non-Autoregressive Multiresolution Sequence Imputation" In \textit{Proceeding of Advances in Neural Information Processing Systems} (NeurIPS), 2019
...
\item ALCF Director’s Discretionary (DD) Program Allocation Award \textit{Graph Neural Networks},  2 million core hours, June 2020 - Jan 2021.
...
\item Jung Yeon (John) Park, 2019, active 
\item Clara De Paolis, 2018, active 
\end{list2}
...
NeurIPS (2020), ICML(2020), IJCAI (2020), SDM (2020)
