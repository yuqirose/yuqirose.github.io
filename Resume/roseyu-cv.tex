...
{\bf Rose Yu}, Guangyu Li, Yan Liu
"Tensor regression meets Gaussian Processes',
Preprint \textit{arXiv:1710.11345}
...
{\bf Rose Yu}, Stephan Zheng. "Learning Chaotic Dynamics with Tensor RNN". Poster accepted to \textit{Advances in Neural Information Processing Systems} (NIPS), time series workshop, 2017

{\bf Rose Yu}, Stephan Zheng, Anima Anandkumar. "Long-term forecasting using Tensor-Train RNN". Poster accepted to \textit{International Conference on Machine Learning} (ICML), Deep structured prediction workshop, 2017
